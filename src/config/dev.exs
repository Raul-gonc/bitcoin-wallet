...
config :bitcoinwallet, BitcoinwalletWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "TGFcxw9iHRJRTrV3XhtN74r1G9ZGtvix6FQIHU8biH/Q1zL6aFi3u2VdosncIENx",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:bitcoinwallet, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:bitcoinwallet, ~w(--watch)]}
  ]
...
config :bitcoinwallet, dev_routes: true
